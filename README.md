# Data-backed Solutions for Combating West Nile Virus in Chicago: Machine-Learning Approach to Minimise Cost and Maximise Benefit
...
![](images/streamlit_screenshot_west_nile.png)
...
| ------------------------ | -----------------------  |
| ![Concerning Numbers](images/concerning_numbers.jpg)| ![Social Cost Loss per Person](images/social_cost_loss_per_person.jpg) |
...
![](images/potential_cost_reduction.jpg)
...
| ------------------------ | -----------------------  |
|![](images/proposal.jpg)|![](images/evaluation_of_proposal.jpg) |
